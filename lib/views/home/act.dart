  ...
  void _loadAnswersFromLocal() {
    ...
    if (savedAnswers != null && savedAnswers is Map) {
      setState(() {
        ...
        _bubbleAnswers['deep-beliefs'] =
            savedAnswers['Deep-Down Beliefs'] ?? '';
        _bubbleAnswers['rules'] = savedAnswers['The Rules'] ?? '';
        _bubbleAnswers['triggers'] = savedAnswers['Triggers'] ?? '';
        _bubbleAnswers['recent-happening'] =
            savedAnswers['A Recent Happening'] ?? '';
        ...
        child: Column(
          children: [
            ...
            Text(
              ...
              style: TextStyle(
                fontSize:
                    16, // slightly bigger since it's displaying the full text
                color: filled
