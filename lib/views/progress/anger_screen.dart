...
const _kName = 'Anger';
const _kTrackerNum = '03';
const _kMaxScore = 40;

const _kItems = [
    TrackerItem(text: 'Small things have set me off more than they should.', reverse: false),
    TrackerItem(text: 'Anger has risen in me fast, before I had time to think.', reverse: false),
    TrackerItem(text: 'The heat of anger has stayed in my body longer than I wanted.', reverse: false),
    TrackerItem(text: 'I have spoken sharply, snapped, or raised my voice at someone.', reverse: false),
    TrackerItem(text: 'I have wanted to hit, throw, slam, or break something.', reverse: false),
    TrackerItem(text: 'I have moved through frustration without losing my footing.', reverse: true),
    TrackerItem(text: 'My anger has caused friction with people I care about.', reverse: false),
    TrackerItem(text: 'Going over situations in my head has fed the anger rather than easing it.', reverse: false),
    TrackerItem(text: 'My reactions have felt bigger than what triggered them.', reverse: false),
    TrackerItem(text: 'I have looked back at how I behaved and wished I had handled it differently.', reverse: false),
];

const _kBands = [
    SeverityBand(max: 9, label: 'Minimal', description: 'Few signs of problematic anger over the past week. The frustrations described here are within the range of everyday experience.'),
    SeverityBand(max: 17, label: 'Mild', description: 'Some signs that anger has been more present or intense than you\'d like. Worth noticing the pattern as you work through the programme.'),
    SeverityBand(max: 25, label: 'Moderate', description: 'A meaningful pattern of anger reactions over the past week. EMDR often helps with the past experiences that fuel reactive anger. Track this score over time to notice changes.'),
    SeverityBand(max: 32, label: 'Marked', description: 'Substantial anger reactions with likely impact on relationships and wellbeing. Continue with the programme, and consider whether speaking to a qualified mental health professional might offer useful additional support.'),
    SeverityBand(max: 40, label: 'Severe', description: 'A high level of anger across multiple areas of life. If any of the items relating to acting on the anger were endorsed (especially items 4 and 5), please consider seeking professional support alongside the programme to ensure both your safety and the safety of those around you.'),
];
...
class AngerScreen extends StatefulWidget {
  const AngerScreen({super.key});

  @override
  State<AngerScreen> createState() => _AngerScreenState();
}

class _AngerScreenState extends State<AngerScreen> {
