...
const _kName = 'Addiction';
const _kTrackerNum = '09';
const _kMaxScore = 40;

const _kItems = [
    TrackerItem(text: 'I have gone back to it more often than I meant to.', reverse: false),
    TrackerItem(text: 'Once started, I have gone further or for longer than I planned.', reverse: false),
    TrackerItem(text: 'I have tried to ease off or stop and found it harder than expected.', reverse: false),
    TrackerItem(text: 'A lot of my time, attention, or energy has been bound up with it.', reverse: false),
    TrackerItem(text: 'The pull toward it has been strong, sometimes intrusive.', reverse: false),
    TrackerItem(text: 'I have felt the choice was mine, freely made.', reverse: true),
    TrackerItem(text: 'It has cost me at work, in study, or in my responsibilities.', reverse: false),
    TrackerItem(text: 'It has caused friction or distance in my relationships.', reverse: false),
    TrackerItem(text: 'I have kept going even as I watched it harm me.', reverse: false),
    TrackerItem(text: 'I have noticed my body or mind asking for more than before, or protesting when I held back.', reverse: false),
];

const _kBands = [
    SeverityBand(max: 9, label: 'Minimal', description: 'Few signs of problematic patterns with the substance or behaviour you are tracking over the past week.'),
    SeverityBand(max: 17, label: 'Mild', description: 'Some signs of problematic patterns. Worth noticing now and continuing to track, particularly if scores are rising over time.'),
    SeverityBand(max: 25, label: 'Moderate', description: 'A meaningful pattern of problematic use over the past week. EMDR can help with the underlying drivers, but addictive patterns at this level often benefit from additional specialist support.'),
    SeverityBand(max: 32, label: 'Marked', description: 'Substantial problems with use, with likely impact on functioning, relationships, and wellbeing. Please consider speaking to your GP or a specialist addiction service alongside the programme.'),
    SeverityBand(max: 40, label: 'Severe', description: 'A high level of problematic use with significant impact across multiple areas of life. At this level, specialist addiction support is strongly recommended — please consider contacting your GP, your local NHS drug and alcohol service, or Frank (0300 123 6600).'),
];

const _kAlerts = [
    TrackerAlert(itemIndex: 8, trigger: '>=2', title: 'Worth taking seriously', message: 'Continuing to use despite knowing it is harming you is one of the more clinically significant patterns in this tracker. EMDR can be helpful for the underlying drivers of addictive behaviour, but ongoing harmful use usually needs additional support to address directly. Consider speaking to your GP or contacting a specialist service such as Frank (0300 123 6600) or your local NHS drug and alcohol service.'),
];
