...
const _kName = 'Depression';
const _kTrackerNum = '02';
const _kMaxScore = 40;

const _kItems = [
    TrackerItem(text: 'A heaviness or flatness has sat with me through the day.', reverse: false),
    TrackerItem(text: 'The things that usually pull me in have felt dull or pointless.', reverse: false),
    TrackerItem(text: 'I have moved through the day with little fuel.', reverse: false),
    TrackerItem(text: 'I have judged myself harshly or felt fundamentally bad.', reverse: false),
    TrackerItem(text: 'My thinking has felt sluggish, foggy, or hard to direct.', reverse: false),
    TrackerItem(text: 'I have felt that the future holds something good.', reverse: true),
    TrackerItem(text: 'My sleep has been off — too little, too much, or restless.', reverse: false),
    TrackerItem(text: 'My relationship to food has shifted noticeably.', reverse: false),
    TrackerItem(text: 'I have felt either weighted down or restless and unable to settle.', reverse: false),
    TrackerItem(text: 'I have had thoughts about not being here, or about ending things.', reverse: false),
];

const _kBands = [
    SeverityBand(max: 9, label: 'Minimal', description: 'Few symptoms of low mood reported in the past week. This is within the range commonly experienced in everyday life.'),
    SeverityBand(max: 17, label: 'Mild', description: 'Some signs of low mood present. These may be noticeable to you but are unlikely to be substantially disrupting daily functioning. Worth tracking week to week as you work through the programme.'),
    SeverityBand(max: 25, label: 'Moderate', description: 'A meaningful pattern of depressive symptoms over the past week. EMDR can be helpful for the experiences that often underlie depression. Track this score over time to notice changes.'),
    SeverityBand(max: 32, label: 'Marked', description: 'Substantial depressive symptoms with likely impact on energy, motivation, and wellbeing. Continue gently with the programme, and consider whether speaking to your GP or a mental health professional might offer useful additional support.'),
    SeverityBand(max: 40, label: 'Severe', description: 'A high level of depressive symptoms with significant impact across multiple areas of life. At this level, additional support is strongly recommended alongside the programme — please consider speaking to your GP or a qualified mental health professional.'),
];

const _kAlerts = [
    TrackerAlert(itemIndex: 9, trigger: '>=1', title: 'Important', message: 'Item 10 has been answered above zero. Any thoughts about not wanting to be here deserve careful attention and are not something to work through alone with a self-directed programme. Please pause your EMDR work for now and reach out for support: contact your GP, the Samaritans (116 123 in the UK), or NHS 111. If you are in immediate danger, call 999.'),
];
