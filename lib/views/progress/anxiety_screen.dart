...
const _kName = 'Anxiety';
const _kTrackerNum = '01';
const _kMaxScore = 40;

const _kItems = [
  TrackerItem(
    text:
        'My body has felt activated when there was no real reason for it (heart, breath, muscles, gut).',
    reverse: false,
  ),
  TrackerItem(
    text: 'I have noticed a background hum of unease that wouldn\'t lift.',
    reverse: false,
  ),
  TrackerItem(
    text: 'My mind has jumped ahead to things that could go wrong.',
    reverse: false,
  ),
  TrackerItem(
    text:
        'I have changed plans or skipped things because of how I expected to feel.',
    reverse: false,
  ),
  TrackerItem(
    text: 'I have struggled to drop into rest, even when the day was done.',
    reverse: false,
  ),
  TrackerItem(
    text: 'My nervous system has felt steady and at ease.',
    reverse: true,
  ),
  TrackerItem(
    text: 'I have felt braced or guarded without knowing what for.',
    reverse: false,
  ),
  TrackerItem(
    text: 'I have noticed it taking longer to recover from small stresses.',
    reverse: false,
  ),
  TrackerItem(
    text: 'My anxiety has spilled into work, study, or daily tasks.',
    reverse: false,
  ),
  TrackerItem(
    text: 'My anxiety has shaped how I show up with the people around me.',
    reverse: false,
  ),
];
...
const _kBands = [
  SeverityBand(
    ...
    label: 'Minimal',
    description:
        'Few symptoms of anxiety reported in the past week. This level of activation is within the range commonly experienced in everyday life.',
  ),
  SeverityBand(
    max: 17,
    label: 'Mild',
    description:
        'Some symptoms of anxiety present. These may be noticeable to you but are unlikely to be substantially disrupting daily life. Worth tracking week to week as you work through the programme.',
  ),
  SeverityBand(
    max: 25,
    label: 'Moderate',
    description:
        'A meaningful pattern of anxiety symptoms over the past week. The EMDR work in this programme is well-suited to addressing the roots of anxiety. Track this score over time to notice changes.',
  ),
  SeverityBand(
    max: 32,
    label: 'Marked',
    description:
        'Substantial anxiety symptoms with likely impact on functioning and wellbeing. Continue with the programme but pace yourself, and consider whether speaking to your GP or a mental health professional might offer useful additional support.',
  ),
  SeverityBand(
    max: 40,
    label: 'Severe',
    description:
        'A high level of anxiety symptoms with significant impact across multiple areas of life. At this level, additional support is recommended alongside the programme — please consider speaking to your GP or a qualified mental health professional.',
  ),
];
...
class _AnxietyScreenState extends State<AnxietyScreen> {
  ...
  SeverityBand get _band =>
      _kBands.firstWhere((b) => _total <= b.max, orElse: () => _kBands.last);
  ...
  Color _intensityColor(int score) {
    switch (score) {
      case 0:
        return _bgCard;
      case 1:
        return const Color(0xFFECF2F1);
      case 2:
        return _accentSoft;
      case 3:
        return const Color(0xFF8FA8A8);
      case 4:
        return _accent;
      default:
        return _bgCard;
      ...
      children: [
        Row(
          children: [
            ...
            Text(
              'InKind EMDR · Symptom Tracker · $_kTrackerNum',
  ...
  Widget _buildSubmitSection() {
    return Column(
      children: [
        Text(
          '$_answeredCount of ${_kItems.length} answered',
