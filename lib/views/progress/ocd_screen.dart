...
const _kName = 'OCD';
const _kTrackerNum = '05';
const _kMaxScore = 40;

const _kItems = [
    TrackerItem(text: 'Thoughts, images, or urges have pushed into my mind that I did not want there.', reverse: false),
    TrackerItem(text: 'I have felt pulled to do something — physical or mental — to settle the discomfort.', reverse: false),
    TrackerItem(text: 'I have repeated actions, checks, or routines more times than was reasonable.', reverse: false),
    TrackerItem(text: 'I have noticed a sense that not doing the routine would mean something bad.', reverse: false),
    TrackerItem(text: 'The unwanted thoughts have stuck, even when I knew they made no sense.', reverse: false),
    TrackerItem(text: 'Intrusive thoughts have passed through me without much grip.', reverse: true),
    TrackerItem(text: 'My rituals or mental routines have eaten significant chunks of my day.', reverse: false),
    TrackerItem(text: 'I have steered around things, people, or places that set the thoughts off.', reverse: false),
    TrackerItem(text: 'The pattern of thoughts and actions has cost me time, energy, or function.', reverse: false),
    TrackerItem(text: 'Being stopped from completing a routine has caused real distress.', reverse: false),
];

const _kBands = [
    SeverityBand(max: 9, label: 'Minimal', description: 'Few signs of obsessive-compulsive symptoms over the past week. Occasional intrusive thoughts and routines are within the range of everyday experience.'),
    SeverityBand(max: 17, label: 'Mild', description: 'Some symptoms of obsessive-compulsive patterns. These may be noticeable but are unlikely to be substantially disrupting daily life. Worth tracking as you work through the programme.'),
    SeverityBand(max: 25, label: 'Moderate', description: 'A meaningful pattern of obsessive-compulsive symptoms over the past week. OCD can have particular treatment needs — if your scores stay at this level or rise, additional support is worth considering.'),
    SeverityBand(max: 32, label: 'Marked', description: 'Substantial obsessive-compulsive symptoms with likely impact on time, energy, and functioning. OCD typically responds best to specific evidence-based treatment. Please consider speaking to your GP or a qualified mental health professional alongside the programme.'),
    SeverityBand(max: 40, label: 'Severe', description: 'A high level of obsessive-compulsive symptoms with significant impact across multiple areas of life. OCD at this level needs specialist support — please consider speaking to your GP or a qualified mental health professional.'),
];
