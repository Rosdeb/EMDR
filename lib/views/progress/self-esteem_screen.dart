...
const _kName = 'Self-Esteem';
const _kTrackerNum = '10';
const _kMaxScore = 40;

const _kItems = [
    TrackerItem(text: 'I have felt that I have value, just as I am.', reverse: false),
    TrackerItem(text: 'I have liked the person I see myself to be.', reverse: false),
    TrackerItem(text: 'I have trusted myself to handle what comes up.', reverse: false),
    TrackerItem(text: 'I have felt that good things in my life are mine to have.', reverse: false),
    TrackerItem(text: 'The voice in my head has been more friend than critic.', reverse: false),
    TrackerItem(text: 'I have felt that I do not measure up, or that something is wrong with me.', reverse: true),
    TrackerItem(text: 'I have felt at home in myself.', reverse: false),
    TrackerItem(text: 'When something kind has been said about me, I have been able to let it land.', reverse: false),
    TrackerItem(text: 'What I think and feel has felt worth voicing.', reverse: false),
    TrackerItem(text: 'My own needs have counted as real, alongside everyone else\'s.', reverse: false),
];

const _kBands = [
    SeverityBand(max: 9, label: 'Very low', description: 'Few signs of healthy self-esteem in the past week. Self-esteem at this level is often associated with substantial distress, and is a useful focus as you work through the programme.'),
    SeverityBand(max: 17, label: 'Low', description: 'Self-esteem has been low across most of the past week. This pattern often shapes how we treat ourselves and what we feel we deserve.'),
    SeverityBand(max: 25, label: 'Mixed', description: 'A mix of healthy and unhealthy self-relating across the past week. Looking at which items scored higher and lower can be a useful map for what to build on.'),
    SeverityBand(max: 32, label: 'Healthy', description: 'A largely healthy relationship with yourself across the past week. There may still be areas to strengthen — the item-by-item view shows where.'),
    SeverityBand(max: 40, label: 'Very healthy', description: 'A consistently healthy relationship with yourself across the past week. Worth noticing what supports this so you can keep returning to it.'),
];
...
class SelfEsteemScreen extends StatefulWidget {
  const SelfEsteemScreen({super.key});

  @override
  State<SelfEsteemScreen> createState() => _SelfEsteemScreenState();
}

class _SelfEsteemScreenState extends State<SelfEsteemScreen> {
