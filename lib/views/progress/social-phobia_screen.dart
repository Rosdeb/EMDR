...
const _kName = 'Social Phobia';
const _kTrackerNum = '04';
const _kMaxScore = 40;

const _kItems = [
    TrackerItem(text: 'I have feared being watched, weighed up, or found wanting.', reverse: false),
    TrackerItem(text: 'I have worried about doing something that would make me look foolish.', reverse: false),
    TrackerItem(text: 'I have skipped or pulled out of social situations I would otherwise have joined.', reverse: false),
    TrackerItem(text: 'My body has betrayed my anxiety in front of others (flushing, shaking, sweating, voice).', reverse: false),
    TrackerItem(text: 'I have over-prepared what to say or planned out interactions in advance.', reverse: false),
    TrackerItem(text: 'I have felt at ease taking up space in front of others.', reverse: true),
    TrackerItem(text: 'After social situations I have picked over what I said and how I came across.', reverse: false),
    TrackerItem(text: 'I have stayed quiet in groups, meetings, or classes when I had something to add.', reverse: false),
    TrackerItem(text: 'I have found everyday acts difficult when others might see me doing them (eating, writing, signing my name).', reverse: false),
    TrackerItem(text: 'Social anxiety has shrunk the life I want to live.', reverse: false),
];

const _kBands = [
    SeverityBand(max: 9, label: 'Minimal', description: 'Few signs of social anxiety over the past week. The level of social discomfort described is within the range of everyday experience.'),
    SeverityBand(max: 17, label: 'Mild', description: 'Some social anxiety present. You may notice it in particular situations but it is unlikely to be substantially disrupting daily life. Worth tracking as you work through the programme.'),
    SeverityBand(max: 25, label: 'Moderate', description: 'A meaningful pattern of social anxiety over the past week. EMDR can help address the experiences that shape social fears. Track this score over time to notice changes.'),
    SeverityBand(max: 32, label: 'Marked', description: 'Substantial social anxiety with likely impact on work, relationships, and wellbeing. Continue with the programme, and consider whether additional support might be useful.'),
    SeverityBand(max: 40, label: 'Severe', description: 'A high level of social anxiety with significant impact across multiple areas of life. At this level, additional support is recommended alongside the programme — please consider speaking to a qualified mental health professional.'),
];
...
class SocialPhobiaScreen extends StatefulWidget {
  const SocialPhobiaScreen({super.key});

  @override
  State<SocialPhobiaScreen> createState() => _SocialPhobiaScreenState();
}

class _SocialPhobiaScreenState extends State<SocialPhobiaScreen> {
